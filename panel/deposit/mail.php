...
$mail->Subject = "Pemberitahuan Deposit"; //subyek email
$mail->AddAddress($dataUser['email'], $dataUser['nama']);  //tujuan email
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style='padding:10px 0 30px 0;'>
                                ...
                                <p>
                                    Segera lakukan transfer sebesar Rp. <b>".number_format($totalJumlah,0,',','.')."</b> ke
                                    <b>".$tujuanDeposit."</b> via <b>".$metodeDeposit."</b>
                                    sebelum 24 Jam.
                                </p>
                            </td>
                        </tr>
