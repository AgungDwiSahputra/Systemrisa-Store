...
$data =array();
$query = mysqli_query($konek, "SELECT * FROM id_ticket");
...
/* Menghitung Semua Data yang ada di Database Tiket */
$data2 =array();
$query2 = mysqli_query($konek, "SELECT * FROM id_ticket WHERE status = 'Unread-Member'");
...
/* Menghitung Semua Data yang ada di Database Tiket */
$data3 =array();
$query3 = mysqli_query($konek, "SELECT * FROM id_ticket WHERE status = 'Read-Admin'");
...
/* Menghitung Semua Data yang ada di Database Tiket */
$data4 =array();
$query4 = mysqli_query($konek, "SELECT * FROM id_ticket WHERE status = 'Read-Member'");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Kelola Tiket</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-warning text-center">
                                                ...
                                                <h6 class="text-white">Belum Dilihat Member</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <div class="col-md-12 col-lg-3 col-xlg-3">
                                        <div class="card card-hover">
                                            <div class="box bg-megna text-center">
                                                ...
                                                <h6 class="text-white">Sudah Dilihat Member</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                            $no = 1;
                                            $qTicket = mysqli_query($konek, "SELECT * FROM id_ticket ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?= $link; ?>/ticket/<?= $rTicket['ticket_id']; ?>" class="font-medium link"><?= $rTicket['judul']; ?></a></td>
                                                <td><a href="<?= $link; ?>/ticket/<?= $rTicket['ticket_id']; ?>" class="font-bold link"><?= $rTicket['ticket_id']; ?></a></td>
