                ...
                <div class="col-md-5 col-sm-12">
                        <div class="card card-hover">
                            <div class="card-header bg-info">
                                ...
                                <i class="mdi mdi-lock m-r-5 display-7 float-left text-white"></i><h4 class="m-b-0 text-white">Reset Password</h4>
                                    <h5 class="card-subtitle text-white-50 mt-1">Reset Password member</h5>
                                </div>
                            </div>
                            <div class="card-body">
                            <form class="form-horizontal" role="form" action="" method="POST">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button class="btn btn-info" type="submit" name="tombol">Reset Password</button>
                                </div>
                            </form>
                            </div>
                        </div>
